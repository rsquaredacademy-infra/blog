...
course_duration <- as.numeric(course_end - course_start) 
duration(course_duration, units = 'hours')
duration(course_duration, units = 'days')
duration(course_duration, units = 'weeks')
```
