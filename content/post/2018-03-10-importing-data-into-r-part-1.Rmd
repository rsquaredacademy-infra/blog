...
```{r img1, fig.align='center'}
knitr::include_graphics('img/mtcars_comma.png')
```

<br>

```{r img2, fig.align='center'}
...
```{r img5, fig.align='center'}
knitr::include_graphics('img/mtcars_comma.png')
```

<br>

```{r img6, fig.align='center'}
