...
In this post, we will learn to work with categorical/qualitative data in R using [forcats](https://forcats.tidyverse.org). Let us begin by installing and loading forcats and a set of other pacakges we will be using.
...
We will use the `traffics` column from the above data.
...
response_data <- read_csv('https://raw.githubusercontent.com/rsquaredacademy/datasets/master/response.csv',
