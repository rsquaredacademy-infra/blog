...
In [part 1](https://blog.rsquaredacademy.com/handling-categorical-data-in-r-part-1/) of this series, we understood what categorical data is, how R stores it using **factor** and got an overview of the case study we will be working on throughout this series.
